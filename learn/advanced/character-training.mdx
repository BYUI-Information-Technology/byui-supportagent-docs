...
The standard approach in the industry is called Reinforcement Learning from Human Feedback, or RLHF

Anthropic, the makers of Claude, developed an innovative new approach to training Large Language Models that they call "[Constitutional AI (CAI)](https://www.anthropic.com/research/constitutional-ai-harmlessness-from-ai-feedback)". This new training methodology represents a fundamental shift in how AI systems learn _ethical_ behavior. 

Rather than training models through external rewards and punishments (RLHF), Constitutional AI trains models to internalize principles and engage in self-reflection—developing something closer to moral reasoning and character than simple behavioral conditioning.
