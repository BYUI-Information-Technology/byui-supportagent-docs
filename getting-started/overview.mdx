...
<Card title="Ask ChatGPT" icon="sparkles" href="https://byui.mintlify.app/getting-started/about-this-site" img="/assets/contextual-menu.png" cta="Learn More">
  This site natively integrates with your favorite AI tools like _ChatGPT_, _Claude_, \_Perplexity, _or even_Cursor_ . To use these features, simply click the **drop-down** menu from "**Copy Page**" on any page.
</Card>
