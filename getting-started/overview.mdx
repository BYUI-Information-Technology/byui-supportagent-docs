...
<Check>
  The Support Agent platform is available to all students and employees. Simply
  visit [supportagent.byui.edu](https://supportagent.byui.edu).
</Check>

<Callout icon="key" color="#006EB6" iconType="regular">
...
<Frame caption="This is how the Support Agent widget appears on a webpage.">
  <img
    src="/assets/agent-widget.gif"
    alt="Animated example of the Support Agent widget"
  />
</Frame>
...
1. **Visit the website**: Go to [https://supportagent.byui.edu](https://supportagent.byui.edu)
