...
<Steps>
  ...
  <Step title="Communicate" icon="message-dots" iconType="regular" stepNumber={3}>
...
<Card title="Beta Disclosure" icon="book-open-reader" iconType="solid" href="resources/beta-disclosure.mdx">
